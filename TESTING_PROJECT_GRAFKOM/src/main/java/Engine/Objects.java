...
public class Objects extends ShaderProgram {
    ...
    // DRAW WITH MULTIPLE COLOR FOR EACH VERTICES
    ...
    public void drawWithColor() {
        ...
        glLineWidth(10);
        glPointSize(10);
        // this lines below is used in glDrawArrays to draw different shapes
        // GL_TRIANGLES
        // GL_LINE_LOOP
        // GL_LINE_STRIP
        // GL_LINES
    ...
    public Boolean getExcludeDraw() {
        return excludeDraw;
    }

    public void setExcludeDraw(Boolean excludeDraw) {
        this.excludeDraw = excludeDraw;
    }
}
